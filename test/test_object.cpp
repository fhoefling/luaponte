...
{
    LUAPONTE_CHECK_STACK(table.interpreter());
...
int test_match(const luaponte::object& o)
{
    return 0;
}
...
void test_main(lua_State* L)
{
    ...
    [
        ...
        def("test_match", (int(*)(const luaponte::object&))&test_match),
