...
#include <luaponte/detail/conversion_storage.hpp>
...
LUAPONTE_API int property_tag(lua_State* L)
{
...
luaponte::detail::class_rep::class_rep(type_id const& type
    , const char* name
    , lua_State* L
)
    : m_type(type)
    ...
    , m_operator_cache(0)
{
    ...
    assert((r->cpp_class() != LUA_NOREF) && "you must call luaponte::open()");
...
luaponte::detail::class_rep::class_rep(lua_State* L, const char* name)
...
luaponte::detail::class_rep::~class_rep()
{
}

// leaves object on lua stack
std::pair<void*,void*>
luaponte::detail::class_rep::allocate(lua_State* L) const
{
...
int luaponte::detail::class_rep::constructor_dispatcher(lua_State* L)
{
...
void luaponte::detail::class_rep::add_base_class(const luaponte::detail::class_rep::base_info& binfo)
{
...
LUAPONTE_API void luaponte::disable_super_deprecation()
{
    super_deprecation_disabled = true;
}

int luaponte::detail::class_rep::super_callback(lua_State* L)
{
    int args = lua_gettop(L);
...
int luaponte::detail::class_rep::lua_settable_dispatcher(lua_State* L)
{
...
/*
    ...
    2: member name
*/
int luaponte::detail::class_rep::static_class_gettable(lua_State* L)
{
    class_rep* crep = static_cast<class_rep*>(lua_touserdata(L, 1));
...
bool luaponte::detail::is_class_rep(lua_State* L, int index)
{
...
void luaponte::detail::finalize(lua_State* L, class_rep* crep)
{
...
void luaponte::detail::class_rep::cache_operators(lua_State* L)
{
...
bool luaponte::detail::class_rep::has_operator_in_lua(lua_State* L, int id)
{
